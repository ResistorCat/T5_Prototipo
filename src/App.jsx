...
function App() {
  ...
  const questions = [
    ...
    },
    {
      ...
      rubric: [
        { id: 'q2_precision', label: 'Precisión', maxPoints: 5 },
      ]
    },
    {
      id: 3,
      ...
      rubric: [
        { id: 'q3_gramatica', label: 'Gramática', maxPoints: 5 },
        { id: 'q3_formato', label: 'Formato', maxPoints: 0 },
      ]
    }
  ]
      ...
      <main className="flex-1 w-full mx-auto p-4 sm:p-6 lg:p-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="space-y-12">
            ...
            <FinalEvaluation totalScore={totalScore} maxScore={maxScore} />
          </div>
        </div>
      </main>
    </div>
